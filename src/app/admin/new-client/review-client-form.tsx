  ...
  return (
    <form onSubmit={submit} className="mt-5 max-w-2xl rounded-card border border-line bg-surface p-6">
      ...
      <div className="mt-4 flex flex-wrap items-end gap-3">
        ...
        <button type="submit" disabled={pending} className="inline-flex h-11 items-center gap-2 rounded-btn bg-accent px-5 text-sm font-semibold text-ink hover:bg-accent-deep disabled:opacity-60">{pending ? "Creating…" : "Create review client"}</button>
      </div>
